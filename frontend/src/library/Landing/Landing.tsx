    ...
    <div className="mx-[12%] md:pt-[60px] pt-[30px]">
      <div className="flex justify-between content-center gap-[5%]">
        <div className="lg:w-[63%] w-full">
          ...
          <div className="flex justify-center content-center gap-[2%]">
            ...
            >
              <span className="text-black font-extrabold italic">Welcome to your music discovery oasis! </span>
              Dive into the world of melodies and rhythms with our intuitive and
              feature-packed music exploration app. Seamlessly search for your
              favorite artists, playlists, or albums to uncover new and exciting tracks and details.
            </p>
          </div>
        </div>
      ...
      <div className="lg:hidden">
        ...
        <div className="mt-[5%] mb-[50px]">
          <h1 className="text-center sm:text-4xl text-2xl font-bold BOBorder border-y-2 m-5 p-3">
            {loggedIn
              ? "Welcome back!"
              : "Interested?"
            }
          ...
          <div className="flex justify-center content-center gap-[2%]">
            <HashLink
              ...
              className="bg-white text-black px-4 py-2 rounded-xl BOBorder font-bold border-2 sm:text-base text-sm
